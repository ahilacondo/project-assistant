...
__all__ = [
    'DISPID_SRCEventInterests', 'SVP_21', 'eLEXTYPE_PRIVATE13',
    'DISPID_SMSSetData', 'DISPID_SPRuleNumberOfElements',
    'SPEI_TTS_AUDIO_LEVEL', 'SpCustomStream', 'DISPID_SGRSTText',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE17',
    'SREStreamStart', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGDictationUnload', 'SRSEIsSpeaking',
    'DISPID_SGRSTPropertyName', 'DISPID_SRDisplayUI',
    'SAFT22kHz16BitMono', 'DISPID_SOTCreateInstance',
    'DISPID_SRSAudioStatus', 'SPBOOKMARKOPTIONS', 'SASStop',
    'SPPS_NotOverriden', '_ISpeechRecoContextEvents',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTsItem',
    'SAFTADPCM_44kHzMono', 'SpeechTokenKeyFiles',
    'DISPID_SRCESoundEnd', 'DISPID_SOTs_NewEnum', 'SPEI_SR_BOOKMARK',
    'DISPID_SVSPhonemeId', 'SRADynamic', 'DISPID_SRAudioInput',
    'SPSEMANTICFORMAT', 'SpAudioFormat', 'DISPID_SRCPause',
    'eLEXTYPE_PRIVATE11', 'DISPID_SVGetVoices', 'DISPID_SPRsCount',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SOTId',
    'SWPUnknownWordPronounceable', 'ISpRecognizer3', 'SpMemoryStream',
    'ISpeechRecoResult2', 'SGPronounciation', 'SPVPRI_OVER',
    'SAFTCCITT_ALaw_22kHzStereo', 'SDTLexicalForm',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechRecoResultTimes', 'SBONone',
    'eLEXTYPE_PRIVATE12', 'tagSPPROPERTYINFO', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRGetFormat', 'DISPID_SOTRemoveStorageFileName',
    'SAFT48kHz8BitMono', 'eWORDTYPE_DELETED', 'SVEPrivate',
    'DISPID_SVResume', 'SAFTNonStandardFormat',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRRPhraseInfo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPRules_NewEnum',
    'DISPID_SRCBookmark', 'DISPID_SOTGetStorageFileName',
    'SP_VISEME_20', 'DISPID_SRGSetTextSelection', 'DISPID_SVSkip',
    'SGRSTTDictation', 'SPINTERFERENCE', 'SPPHRASE',
    'SRSActiveAlways', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechPhraseRules',
    'SpMMAudioIn', 'DISPID_SFSClose', 'DISPID_SpeechBaseStream',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechVoiceStatus', 'SPEI_START_INPUT_STREAM',
    'SGLexicalNoSpecialChars', 'SPSVerb', 'DISPID_SOTIsUISupported',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechRecoProfileProperties',
    'SAFTGSM610_44kHzMono', 'SPWT_DISPLAY', 'DISPID_SVSpeak',
    'SSFMOpenReadWrite', 'SpPhraseInfoBuilder',
    ...
    'SPSERIALIZEDRESULT', 'SPPS_Function', 'SVPNormal',
    'DISPID_SRRAudio', 'SpeechVisemeType', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpeechAudioStatus', 'DISPID_SPRFirstElement', 'SREAudioLevel',
    'eLEXTYPE_PRIVATE14', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCAudioInInterferenceStatus', 'eLEXTYPE_PRIVATE8',
    'SP_VISEME_1', 'SpeechCategoryRecoProfiles',
    'DISPID_SRAudioInputStream', 'SAFT44kHz16BitStereo',
    'DISPID_SVSVisemeId', 'DISPID_SRState', 'DISPID_SRCEPhraseStart',
    'DISPID_SMSALineId', 'DISPID_SPIGetText', 'DISPID_SVEWord',
    'ISpeechObjectTokens', 'DISPID_SWFEAvgBytesPerSec',
    'ISpProperties', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTGetDescription', 'DISPID_SAFGetWaveFormatEx',
    'SAFT11kHz16BitStereo', 'ISpNotifySink', 'DISPID_SRCEHypothesis',
    'DISPID_SOTCId', 'SVEBookmark', 'SVSFIsNotXML',
    'DISPID_SPIEngineId', 'ISpeechLexiconPronunciation',
    'SRAInterpreter', 'DISPID_SPPsItem', 'DISPID_SMSGetData',
    'DISPID_SGRSTransitions', 'DISPID_SRCRetainedAudioFormat',
    'ISpNotifyTranslator', 'ISpMMSysAudio',
    'DISPID_SVSInputWordPosition', 'SDTAlternates',
    'ISpPhoneticAlphabetSelection', 'SDA_Consume_Leading_Spaces',
    'SVEVoiceChange', 'SPAO_RETAIN_AUDIO', 'SPPHRASERULE',
    'DISPID_SPPParent', 'SPLEXICONTYPE', 'ISpEventSource', 'SVP_20',
    'eWORDTYPE_ADDED', 'SAFT44kHz16BitMono', 'DISPID_SVVolume',
    'DISPID_SRCESoundStart', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechObjectToken', 'ISpeechPhraseInfo', 'DISPID_SAFGuid',
    'SSSPTRelativeToStart', 'DISPID_SPIEnginePrivateData',
    'SPEI_RESERVED3', 'DISPID_SpeechPhraseElement', 'DISPID_SPPValue',
    'SSTTWildcard', 'ISpeechPhraseAlternate',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRGetXMLResult',
    'SP_VISEME_14', 'SLTApp', 'DISPID_SOTCSetId', 'DISPID_SASetState',
    'SpeechPropertyResourceUsage', 'ISpObjectToken', 'ISpeechVoice',
    'DISPID_SRCEBookmark', 'SAFTADPCM_22kHzStereo',
    'ISpPhoneticAlphabetConverter', 'ISpeechGrammarRule',
    'DISPID_SASFreeBufferSpace', 'SpLexicon',
    'Speech_StreamPos_RealTime', 'DISPID_SVEBookmark',
    'SpeechStreamFileMode', 'SPRST_ACTIVE', 'DISPID_SVSRunningState',
    'SpeechVoiceEvents', 'ISpeechPhoneConverter',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRegistryUserRoot',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SREmulateRecognition',
    'ISpNotifySource', 'SPEI_RESERVED1', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPRuleChildren', 'SVP_6', 'DISPID_SpeechLexiconProns',
    'SPPS_SuppressWord', 'SITooSlow', 'SpeechInterference',
    'DISPID_SRCERecognition', 'SPCT_DICTATION', 'SECFIgnoreKanaType',
    'DISPID_SVIsUISupported', 'DISPID_SGRInitialState', 'SINoise',
    'SVP_5', 'IInternetSecurityMgrSite', 'SpeechRecoEvents',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRSetPropertyNumber',
    'SPAS_CLOSED', 'DISPID_SABufferInfo',
    'SpeechEmulationCompareFlags', 'SDTAll', 'SPEI_END_SR_STREAM',
    'DISPID_SCSBaseStream', 'DISPID_SRCEEndStream', 'SFTSREngine',
    'SPINTERFERENCE_NONE', 'SPSHT_OTHER', 'DISPID_SRCEAudioLevel',
    'DISPID_SAFSetWaveFormatEx', 'SPSHT_NotOverriden',
    'DISPID_SPIRule', 'DISPID_SRCERecognizerStateChange',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_FALSE_RECOGNITION',
    'ISpeechAudioFormat', 'DISPID_SGRsAdd', 'Speech_Max_Word_Length',
    'SECFEmulateResult', 'ISpeechBaseStream', 'SpeechUserTraining',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechAllElements',
    'DISPID_SPARecoResult', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechRecoResult', 'ISpRecoContext', 'ISpAudio',
    'SREPhraseStart', 'SPBO_PAUSE', 'DISPID_SVStatus', 'SPEVENTENUM',
    'SPEVENT', 'SVSFParseMask', 'DISPID_SASCurrentDevicePosition',
    'SVF_None', 'DISPID_SRGCmdSetRuleState', 'SPEI_END_INPUT_STREAM',
    'SPRST_ACTIVE_ALWAYS', 'SpeechRetainedAudioOptions',
    'SPSHORTCUTPAIR', 'DISPID_SVSLastResult', 'SpeechRecognitionType',
    'DISPID_SPPNumberOfElements', 'ISpeechVoiceStatus',
    'ISpeechFileStream', 'SPWORDPRONOUNCEABLE', 'SSTTDictation',
    'SPPHRASEELEMENT', 'SVSFParseAutodetect', 'DISPID_SPEsCount',
    'SpeechLexiconType', 'eLEXTYPE_PRIVATE15', 'STSF_AppData',
    'DISPID_SFSOpen', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPRulesCount', 'DISPID_SMSADeviceId',
    'DISPID_SPEActualConfidence', 'SPCT_SUB_DICTATION',
    'DISPID_SRRTLength', 'DISPID_SLGetWords', 'SP_VISEME_0',
    'SPDKL_LocalMachine', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpRecoCategory', 'DISPID_SRGetPropertyString',
    'SWPKnownWordPronounceable', 'DISPID_SLAddPronunciation',
    'DISPID_SPRuleId', 'ISpeechRecoGrammar', 'DISPID_SRCRecognizer',
    'SPPHRASEREPLACEMENT', 'DISPID_SVSpeakStream',
    'SpeechBookmarkOptions', 'SpeechGrammarTagDictation',
    'DISPID_SpeechPhraseAlternates', 'SpeechRegistryLocalMachineRoot',
    'SpeechTokenKeyAttributes', 'SPSTREAMFORMATTYPE',
    'SpCompressedLexicon', 'ISpeechPhraseProperties',
    'DISPID_SPCPhoneToId', 'DISPID_SGRsCommitAndSave',
    'DISPID_SOTGetAttribute', 'SRCS_Enabled', 'SPEI_MIN_TTS', 'SVP_0',
    'SPSFunction', 'SPLO_STATIC', 'ISpStreamFormatConverter',
    'SVP_10', 'SpeechPropertyAdaptationOn', 'DISPID_SPPs_NewEnum',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRs_NewEnum', 'DISPID_SPPId',
    'SREPropertyNumChange', 'SPRS_ACTIVE', 'DISPID_SRCState',
    'DISPID_SPIStartTime', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPACommit',
    'ISpeechLexiconWord', 'DISPID_SpeechLexiconWords',
    'DISPID_SLWsCount', 'DISPID_SWFEFormatTag', 'DISPID_SGRSRule',
    'DISPID_SGRSTPropertyId', 'SP_VISEME_6',
    'SpeechPropertyHighConfidenceThreshold', 'SPCS_ENABLED',
    'DISPID_SGRSTWeight', 'SAFT11kHz16BitMono', 'DISPID_SPRsItem',
    'DISPID_SRRDiscardResultInfo', 'SpInProcRecoContext',
    'SRSInactive', 'SpeechDataKeyLocation', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechPhraseProperties',
    'SRSInactiveWithPurge', 'SAFT44kHz8BitMono', 'SVSFlagsAsync',
    'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE7', 'DISPID_SRGId',
    'SREStreamEnd', 'SPEI_MAX_TTS', 'STSF_CommonAppData',
    'SPEI_HYPOTHESIS', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPRText', 'DISPID_SVPause', 'DISPID_SPIGrammarId',
    'DISPID_SRRRecoContext', 'DISPID_SPPName', 'DISPID_SLPType',
    'DISPID_SOTsCount', 'DISPID_SpeechObjectTokenCategory',
    'eLEXTYPE_PRIVATE19', 'DISPID_SDKGetStringValue',
    'SpeechAudioState', 'ISequentialStream', 'SPBO_TIME_UNITS',
    'SAFT24kHz8BitStereo', 'SPEI_RECOGNITION', 'SP_VISEME_4',
    'SpeechTokenContext', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPRuleFirstElement', 'DISPID_SLWsItem', 'SPEI_RESERVED2',
    'SpSharedRecognizer', 'SPWAVEFORMATTYPE', 'SREPrivate',
    'SpeechPropertyComplexResponseSpeed', 'SPPS_Interjection',
    'ISpPhrase', 'DISPID_SpeechGrammarRule',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGCmdSetRuleIdState', 'SITooLoud',
    'DISPID_SRIsUISupported', 'SPPS_RESERVED1', 'SPAR_Unknown',
    'SPPHRASEPROPERTY', 'SVP_1', 'SSTTTextBuffer',
    'DISPID_SpeechVoice', 'DISPID_SRCVoice',
    'DISPID_SPRuleEngineConfidence',
    'SpeechPropertyNormalConfidenceThreshold', 'SPCT_COMMAND',
    'SVP_3', 'SDTPronunciation', 'SpObjectTokenCategory',
    'SP_VISEME_13', 'DISPID_SVEventInterests', 'SPFM_NUM_MODES',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPILanguageId', 'UINT_PTR',
    'SPEI_VISEME', 'DISPID_SPPConfidence',
    ...
    'DISPID_SRStatus', 'SPEI_SOUND_END', 'SVSFNLPSpeakPunc',
    'ISpeechPhraseProperty', 'DISPID_SPRulesItem',
    'DISPID_SVSInputWordLength', 'DISPID_SLWs_NewEnum',
    'ISpRecoGrammar2', 'DISPID_SPEDisplayAttributes',
    'ISpeechGrammarRuleState', 'SSFMCreate', 'SPAR_High',
    'DISPID_SpeechPhraseInfo', 'SRERequestUI', 'ISpeechPhraseRule',
    'DISPID_SOTCGetDataKey', 'DISPID_SVEStreamStart', 'SVEAudioLevel',
    'SpeechGrammarState', 'DISPID_SOTDataKey', 'SVESentenceBoundary',
    'STSF_FlagCreate', 'SPGS_DISABLED', 'SECFIgnoreCase',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechRecognizer',
    'SAFT48kHz8BitStereo', 'SECFIgnoreWidth', 'ISpeechPhraseElements',
    'DISPID_SpeechAudioStatus', 'SpUnCompressedLexicon',
    'SPFM_CREATE_ALWAYS', 'SpMMAudioEnum', 'DISPID_SRGetRecognizers',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechEngineProperties',
    'SAFT24kHz8BitMono', 'SRAExport', 'SAFTCCITT_ALaw_11kHzStereo',
    'SP_VISEME_11', 'SRSActive', 'SP_VISEME_15', 'SpeechRunState',
    'SPSUnknown', 'SPCS_DISABLED', 'SPVPRI_ALERT',
    'SPEI_WORD_BOUNDARY', 'SAFTNoAssignedFormat', 'ISpeechAudio',
    'SVPAlert', 'ISpRecognizer2', 'SpFileStream',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SLWType', 'SAFTGSM610_8kHzMono', 'SLOStatic',
    'SRTEmulated', 'DISPID_SOTMatchesAttributes', 'SPCONTEXTSTATE',
    'SVSFParseSapi', 'DISPID_SWFEBitsPerSample', 'SPEI_PHONEME',
    'DISPID_SRRAudioFormat', 'ISpeechXMLRecoResult',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SLWWord', 'SVPOver',
    'SGRSTTWord', 'SREStateChange', 'SVEViseme', 'SSFMOpenForRead',
    ...
    'DISPID_SBSWrite', 'ISpRecoResult', 'SPEI_INTERFERENCE',
    'SECFNoSpecialChars', 'DISPID_SPAs_NewEnum', 'ISpeechRecognizer',
    'DISPID_SpeechMMSysAudio', 'ISpObjectTokenCategory',
    'DISPID_SpeechDataKey', 'SRCS_Disabled', 'SPEI_SR_AUDIO_LEVEL',
    'IInternetSecurityManager', 'DISPID_SPEAudioSizeTime', 'SLTUser',
    'ISpeechMMSysAudio', 'SPPS_RESERVED2', 'DISPID_SLWLangId',
    'SRADefaultToActive', 'SPINTERFERENCE_NOISE', 'SPAUDIOBUFFERINFO',
    'SVP_12', 'DISPID_SAEventHandle', '_RemotableHandle', 'SPPS_LMA',
    'SpeechDisplayAttributes', 'SVP_4', 'DISPID_SDKSetLongValue',
    'DISPID_SWFEChannels', 'DISPID_SADefaultFormat',
    'DISPID_SVEViseme', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRCEFalseRecognition', 'SPEI_RESERVED6',
    'DISPID_SPIRetainedSizeBytes', 'SP_VISEME_2',
    'DISPID_SpeechLexicon', 'SpeechFormatType',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRGCmdLoadFromFile',
    'SREFalseRecognition', 'SP_VISEME_19', 'SAFTExtendedAudioFormat',
    'DISPID_SRCreateRecoContext', 'SpeechMicTraining', 'SPXRO_SML',
    'DISPID_SVEPhoneme', 'SPINTERFERENCE_TOOFAST', 'SRTSMLTimeout',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SRAImport',
    'SPFM_OPEN_READONLY', 'DISPIDSPTSI',
    'ISpeechTextSelectionInformation', 'DISPID_SPRuleName',
    'SAFT12kHz8BitStereo', 'DISPID_SPAsItem', 'DISPID_SPPChildren',
    'DISPID_SAStatus', 'DISPID_SPPEngineConfidence',
    'eLEXTYPE_PRIVATE18', 'SpeechRecognizerState',
    'SpNullPhoneConverter', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SGRsFindRule', 'SPRULE', 'ISpeechObjectTokenCategory',
    'DISPID_SDKDeleteKey', 'SPEI_PHRASE_START', 'SDTProperty',
    'SPPS_Unknown', 'SAFT24kHz16BitStereo', 'ISpShortcut',
    'SGDSActiveUserDelimited', 'SAFT44kHz8BitStereo', 'SGDisplay',
    'SPAUDIOSTATUS', 'DISPID_SRRGetXMLErrorInfo',
    'ISpObjectWithToken', 'SAFT11kHz8BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpLexicon',
    'eLEXTYPE_RESERVED8', 'SPGRAMMARSTATE', 'DISPID_SLPs_NewEnum',
    'SPAUDIOOPTIONS', 'DISPID_SPCIdToPhone', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechRecoContext', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPSHORTCUTTYPE', 'SAFTGSM610_11kHzMono', 'SPSNotOverriden',
    'SPSLMA', 'ISpeechResourceLoader', 'DISPID_SLPSymbolic',
    'SPRST_NUM_STATES', 'DISPID_SVGetAudioOutputs',
    'DISPID_SGRSTs_NewEnum', 'ISpeechLexicon', 'SPPS_Noun',
    'SRERecoOtherContext', 'DISPIDSPTSI_ActiveLength', 'tagSTATSTG',
    'DISPID_SABIEventBias', 'DISPID_SOTDisplayUI',
    'DISPID_SDKOpenKey', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_RESERVED4',
    'DISPID_SBSFormat', 'SASRun', 'ISpeechPhraseReplacement',
    'DISPID_SGRsCommit', 'SGDSActiveWithAutoPause', 'STCInprocServer',
    'SDA_No_Trailing_Space', 'DISPIDSPRG', 'IStream',
    'SPEI_TTS_BOOKMARK', 'DISPIDSPTSI_ActiveOffset',
    'SpeechCategoryPhoneConverters', 'SINone', 'SPEI_ADAPTATION',
    'ISpeechRecoResult', 'DISPID_SRCERecognitionForOtherContext',
    'SDKLCurrentUser', 'SpeechVoiceSkipTypeSentence',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechPhraseElements',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechPhraseRules', 'DISPID_SDKGetBinaryValue',
    'DISPID_SVGetProfiles', 'SP_VISEME_10', 'DISPID_SGRSTsItem',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SGRAddResource',
    'DISPID_SLPPartOfSpeech', 'ISpSerializeState', 'SVP_9',
    'DISPID_SVVoice', 'DISPID_SPIElements', 'SINoSignal',
    'ISpRecoGrammar', 'SRTStandard', 'SPWORDLIST', 'STCAll',
    'DISPID_SVEVoiceChange', 'SPTEXTSELECTIONINFO',
    'SVEEndInputStream', 'SAFT32kHz8BitStereo',
    'SpeechStreamSeekPositionType', 'DISPID_SPEsItem',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SECFDefault', 'DISPID_SLPsCount',
    'DISPID_SpeechRecoContextEvents', 'SDA_One_Trailing_Space',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechMemoryStream', 'SpeechAudioFormatGUIDText',
    'SGSEnabled', 'DISPID_SpeechPhraseBuilder', 'DISPID_SOTSetId',
    'SpeechGrammarTagUnlimitedDictation',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRCResume', 'SDTRule',
    'SAFT8kHz16BitMono', 'ISpeechMemoryStream', 'SpeechWordType',
    '_SPAUDIOSTATE', 'SpeechVoicePriority', 'SP_VISEME_3',
    'SAFTCCITT_ALaw_11kHzMono', 'SpWaveFormatEx',
    'DISPID_SVEEnginePrivate', 'ISpVoice', 'SP_VISEME_8',
    'SPRST_INACTIVE', 'DISPID_SGRSTType', 'SAFT12kHz16BitMono',
    ...
    'DISPID_SRRecognizer', 'DISPID_SGRSTRule', 'SWTDeleted',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SASNonBlockingIO',
    'SAFT22kHz8BitStereo', 'IEnumString', 'DISPID_SPPFirstElement',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE20', 'DISPID_SBSSeek',
    'SDTAudio', 'SREInterference', 'DISPID_SABIBufferSize', 'SVP_8',
    'eLEXTYPE_PRIVATE4', 'SpeechVisemeFeature',
    'DISPID_SPAPhraseInfo', 'SPEVENTSOURCEINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE2',
    'DISPID_SASState', 'SVSFPersistXML', 'SPCT_SUB_COMMAND',
    'DISPID_SGRAddState', 'SP_VISEME_12',
    'DISPID_SLGetPronunciations', 'DISPID_SPIAudioStreamPosition',
    'SSSPTRelativeToEnd', 'SVEStartInputStream', 'SP_VISEME_17',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPPsCount',
    'SPDKL_CurrentConfig', 'SPFILEMODE',
    'SpeechSpecialTransitionType', 'SAFTText', 'SPWF_SRENGINE',
    'SAFT48kHz16BitMono', 'ISpeechGrammarRuleStateTransitions',
    'SpStreamFormatConverter', 'SGLexical', 'SRAORetainAudio',
    'SVP_7', 'SPXRO_Alternates_SML', 'DISPID_SPCLangId',
    'DISPID_SBSRead', 'DISPID_SRCCreateResultFromMemory',
    'SPVPRI_NORMAL', 'DISPID_SPRuleConfidence',
    'DISPID_SVSLastBookmark', 'DISPID_SDKDeleteValue',
    'tagSPTEXTSELECTIONINFO', 'SAFT22kHz8BitMono', 'SPEI_MIN_SR',
    'SDTDisplayText', 'SPEI_RESERVED5', 'SRTAutopause',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPIReplacements',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechCategoryAudioOut', 'DISPID_SRSCurrentStreamPosition',
    'SPPS_RESERVED3', 'ISpeechDataKey', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_18', 'SVP_13', 'SPSMF_UPS', 'DISPID_SRGState',
    ...
    'DISPID_SpeechVoiceEvent', 'DISPID_SGRId', 'ISpeechGrammarRules',
    'STCInprocHandler', 'SVSFNLPMask', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPBO_NONE', 'SFTInput', 'SVP_15', 'DISPID_SRCRequestedUIType',
    'SECLowConfidence', 'SRTExtendableParse', 'SP_VISEME_7',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechXMLRecoResult', 'SREPropertyStringChange',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGRules',
    'SAFT22kHz16BitStereo', 'SPINTERFERENCE_NOSIGNAL',
    'SREHypothesis', 'SDKLCurrentConfig', 'SPCATEGORYTYPE',
    'eLEXTYPE_USER', 'SPRECOSTATE', 'eLEXTYPE_RESERVED6',
    'ISpGrammarBuilder', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPPARTOFSPEECH', 'DISPID_SLGenerationId', 'DISPID_SVAudioOutput',
    'ISpeechPhraseAlternates', 'DISPID_SGRsItem', 'SGSDisabled',
    'SPINTERFERENCE_TOOLOUD', 'SPWORDTYPE', 'eLEXTYPE_RESERVED7',
    'STCRemoteServer', 'eLEXTYPE_RESERVED10', 'STSF_LocalAppData',
    'SRTReSent', 'SPADAPTATIONRELEVANCE', 'SpeechAudioVolume',
    'eLEXTYPE_APP', 'SPVISEMES', 'SPPROPERTYINFO', 'SPEI_REQUEST_UI',
    'SPEI_RECO_STATE_CHANGE', 'SpeechDictationTopicSpelling',
    'ISpResourceManager', 'DISPID_SRCERequestUI', 'SVEAllEvents',
    ...
    'SPAS_STOP', 'DISPID_SOTCDefault', 'SPEI_PROPERTY_STRING_CHANGE',
    'SDTReplacement', 'ISpPhraseAlt', 'DISPID_SVWaitUntilDone',
    'DISPID_SRIsShared', 'SAFT12kHz16BitStereo',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCRetainedAudio',
    'SPDKL_DefaultLocation', 'SPGRAMMARWORDTYPE', 'SPCT_SLEEP',
    'SPAR_Low', 'DISPID_SGRsDynamic', 'SPSMF_SAPI_PROPERTIES',
    'SASPause', 'SPVOICESTATUS', 'LONG_PTR',
    'SAFTCCITT_uLaw_22kHzMono', 'SpTextSelectionInformation',
    'SpeechCategoryRecognizers', 'SAFT8kHz8BitStereo', 'SVP_19',
    'DISPID_SGRClear', 'DISPID_SRSNumberOfActiveRules',
    'SpeechGrammarTagWildcard', 'SVSFUnusedFlags',
    'DISPID_SPIProperties', 'SPRS_INACTIVE', 'SAFTDefault',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRGReset', 'DISPID_SVEStreamEnd',
    'ISpeechPhraseInfoBuilder', 'DISPID_SGRsCount', 'SVEPhoneme',
    'ISpStreamFormat', 'SPEI_VOICE_CHANGE', 'SVF_Stressed',
    'SpeechLoadOption', 'SPSSuppressWord', 'SPLO_DYNAMIC',
    'DISPID_SVSInputSentencePosition', 'SBOPause', 'SPWORD',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRRSetTextFeedback',
    '__MIDL_IWinTypes_0009', 'ISpEventSink', 'eLEXTYPE_PRIVATE5',
    'SDKLLocalMachine', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRRTStreamTime',
    'DISPID_SDKCreateKey', 'DISPID_SPEPronunciation',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SAFType',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVF_Emphasis',
    'SPXMLRESULTOPTIONS', 'ISpeechCustomStream', 'DISPID_SGRSTsCount',
    'SpNotifyTranslator', 'SECHighConfidence', 'SGRSTTTextBuffer',
    'DISPID_SpeechWaveFormatEx', 'SPEI_SOUND_START',
    'SPDATAKEYLOCATION', 'SPAO_NONE', 'SGRSTTEpsilon', 'SVP_17',
    'ISpeechRecoResultDispatch', 'SP_VISEME_16',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREAllEvents',
    'DISPID_SDKEnumValues', 'SPSHT_Unknown', 'SPRECORESULTTIMES',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPEAudioSizeBytes',
    'SpeechAudioProperties', 'SAFT16kHz8BitStereo',
    'SpeechWordPronounceable', 'DISPID_SRRTimes',
    'SpeechCategoryVoices', 'SP_VISEME_5',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPAsCount',
    'DISPID_SPRuleParent', 'SPAS_PAUSE', 'SRSEDone',
    'DISPID_SRCEStartStream', 'SAFT16kHz8BitMono', 'SVP_14',
    'IEnumSpObjectTokens', 'DISPID_SGRSTNextState',
    'SAFT32kHz16BitStereo', 'SPGS_EXCLUSIVE', 'SpStream',
    'SPBO_AHEAD', 'DISPID_SVSpeakCompleteEvent', 'SPEI_UNDEFINED',
    'DISPID_SPAStartElementInResult', 'SGRSTTWildcard',
    'ISpeechPhraseElement', 'SVP_18', 'SPINTERFERENCE_TOOQUIET',
    'ISpRecognizer', 'DISPID_SRRTTickCount', 'SGSExclusive',
    'SDKLDefaultLocation', 'ISpeechObjectToken', 'SRATopLevel',
    'ISpeechRecoContext', 'DISPID_SRProfile', 'eLEXTYPE_PRIVATE9',
    'SPSModifier', 'STCLocalServer', 'SAFT8kHz8BitMono',
    'SpeechTokenShellFolder', 'WAVEFORMATEX', 'SpeechGrammarWordType',
    'SpeechTokenValueCLSID', 'SpeechCategoryAppLexicons',
    'DISPID_SDKEnumKeys', 'SRESoundStart', 'SPSInterjection',
    'SPSHT_EMAIL', 'DISPID_SRCEPropertyStringChange', 'SPWT_LEXICAL',
    'SPEI_MAX_SR', 'ISpPhoneConverter', 'DISPID_SLPPhoneIds',
    'SGDSInactive', 'ISpStream', 'DISPID_SABIMinNotification',
    'eLEXTYPE_PRIVATE16', 'SGRSTTRule', 'DISPID_SRGIsPronounceable',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPPS_Noncontent',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SDKSetBinaryValue',
    'SREBookmark', 'SPGS_ENABLED', 'DISPID_SPEDisplayText',
    'SRAONone', 'SPRST_INACTIVE_WITH_PURGE', 'SpShortcut',
    'DISPID_SRGRecoContext', 'SVSFIsFilename', 'ISpDataKey',
    'SpMMAudioOut', 'DISPID_SRSClsidEngine', 'SRERecognition',
    'ISpXMLRecoResult', 'SPAR_Medium', 'SAFT11kHz8BitStereo',
    'SPPS_RESERVED4', 'SPSEMANTICERRORINFO', 'ISpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE1', 'SpeechAddRemoveWord',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEInterference',
    'DISPID_SLGetGenerationChange', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SWFEBlockAlign', 'SLODynamic', 'SPWT_PRONUNCIATION',
    'SAFTCCITT_uLaw_11kHzMono', 'SREAdaptation',
    'Speech_Default_Weight', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechAudio',
    'DISPID_SpeechObjectTokens', 'SVSFDefault',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLRemovePronunciation',
    '_ISpeechVoiceEvents', 'SpeechCategoryAudioIn',
    'SAFT12kHz8BitMono', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVRate',
    'ISpeechRecognizerStatus', 'DISPID_SOTCategory',
    'SpeechDiscardType', 'SP_VISEME_21', 'SVSFIsXML',
    'SPINTERFERENCE_LATENCY_WARNING', 'Speech_StreamPos_Asap',
    'SPEI_SR_PRIVATE', 'SVP_16', 'Speech_Max_Pron_Length',
    'SVSFVoiceMask', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPELexicalForm', 'SpObjectToken',
    'DISPID_SPRDisplayAttributes', 'SITooFast', 'DISPID_SVPriority',
    'SECNormalConfidence', 'DISPID_SPEEngineConfidence',
    'SPLOADOPTIONS', 'SPRECOCONTEXTSTATUS', 'DISPID_SpeechFileStream',
    'SPRULESTATE', 'SAFT24kHz16BitMono', 'DISPID_SpeechGrammarRules',
    'ISpeechAudioBufferInfo', 'SpeechAudioFormatType',
    'SPPS_Modifier', 'DISPID_SVAlertBoundary',
    'DISPID_SLWPronunciations', 'SpeechPartOfSpeech',
    'SAFT32kHz16BitMono', 'SRESoundEnd',
    'ISpeechLexiconPronunciations', 'SPBINARYGRAMMAR',
    'DISPID_SVEAudioLevel', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SGRSTPropertyValue', 'SAFTADPCM_11kHzMono',
    'DISPID_SGRName', 'SVP_11', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpInprocRecognizer', 'DISPID_SWFESamplesPerSec',
    'DISPID_SOTRemove', 'SASClosed', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVDisplayUI', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SAVolume', 'SpVoice',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechRecoResult2', 'DISPID_SWFEExtraData',
    'DISPID_SLPLangId', 'SpeechEngineConfidence',
    'DISPID_SGRs_NewEnum', 'SWTAdded', 'DISPID_SRCCreateGrammar',
    'SPEI_START_SR_STREAM', 'DISPID_SRCEAdaptation',
    'SSFMCreateForWrite', 'SpeechTokenKeyUI', 'eLEXTYPE_PRIVATE3',
    'SPFM_OPEN_READWRITE', 'ISpeechPhraseReplacements',
    'SAFT32kHz8BitMono', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechRecognizerStatus', 'SVSFParseSsml', 'SPAS_RUN',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGCommit', 'SPFM_CREATE',
    'DISPID_SRCCmdMaxAlternates', 'SpeechRecoContextState',
    'SPWF_INPUT', 'SAFT48kHz16BitStereo', 'SAFTADPCM_22kHzMono',
    'SVEWordBoundary', 'SP_VISEME_9', 'SVP_2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPISaveToMemory', 'DISPID_SASCurrentSeekPosition',
    'SPSNoun'
]

_check_version('1.2.0', 1697005312.238687)
