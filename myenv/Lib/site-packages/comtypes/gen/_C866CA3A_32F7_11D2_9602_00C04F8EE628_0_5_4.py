...
__all__ = [
    'SPRECOGNIZERSTATUS', 'DISPID_SMSSetData',
    'DISPID_SLAddPronunciation', 'SAFT11kHz8BitStereo',
    'SGDSActiveUserDelimited', 'DISPID_SPEsCount',
    'DISPID_SRRecognizer', 'SDKLLocalMachine', 'DISPID_SRCState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechStreamFileMode',
    '_SPAUDIOSTATE', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_PROPERTY_NUM_CHANGE', 'SRCS_Enabled', 'SPVOICESTATUS',
    'SpMMAudioEnum', 'ISpeechXMLRecoResult', 'SVSFParseSsml',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechFileStream',
    'SAFT11kHz16BitMono', 'SP_VISEME_7',
    'DISPID_SPERequiredConfidence', 'SPBO_TIME_UNITS',
    'DISPID_SPRuleConfidence', 'SVEVoiceChange', 'SPWF_INPUT',
    'DISPID_SPRNumberOfElements', 'SSFMOpenForRead', 'SPLO_DYNAMIC',
    'DISPID_SRState', 'DISPID_SGRsFindRule',
    'DISPID_SGRSTPropertyName', 'SpPhoneConverter',
    'DISPID_SpeechWaveFormatEx', 'ISpRecognizer3', 'SPPS_Noun',
    'SpeechEngineProperties', 'DISPID_SMSGetData',
    'ISpeechRecognizerStatus', 'DISPID_SPRulesCount',
    'DISPID_SGRName', 'SPSLMA', 'SPPS_Verb', 'DISPID_SVEVoiceChange',
    'SPGS_DISABLED', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SLPs_NewEnum', 'SpeechPropertyNormalConfidenceThreshold',
    'SPDATAKEYLOCATION', 'SREFalseRecognition', 'ISpeechAudioFormat',
    'eLEXTYPE_APP', 'SpeechTokenShellFolder',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE10',
    'SAFTADPCM_22kHzMono', 'SPEI_RESERVED5', 'ISpeechGrammarRules',
    'ISpStreamFormatConverter', 'IInternetSecurityManager',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_12',
    'IStream', 'DISPID_SMSALineId', 'ISpeechLexicon',
    'SAFT44kHz16BitStereo', 'DISPID_SRGetPropertyString',
    'SpObjectToken', 'DISPID_SRAudioInput', 'ISpResourceManager',
    'SVP_7', 'DISPID_SVSVisemeId', 'SGRSTTTextBuffer',
    'SPTEXTSELECTIONINFO', 'SpeechAudioFormatType',
    'DISPID_SPISaveToMemory', 'SpeechPropertyResponseSpeed',
    'DISPID_SVSyncronousSpeakTimeout', 'SRSEIsSpeaking',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechRecoResult2',
    'SPSModifier', 'DISPID_SOTDisplayUI', 'DISPID_SPILanguageId',
    'DISPID_SPEPronunciation', 'ISpNotifyTranslator',
    'DISPID_SRCEFalseRecognition', 'DISPID_SMSADeviceId',
    'SDKLDefaultLocation', 'SASClosed', 'DISPID_SGRSRule',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SLPType',
    'DISPID_SLWs_NewEnum', 'DISPID_SVSPhonemeId', 'SRARoot',
    'SPVISEMES', 'DISPID_SREmulateRecognition',
    'DISPID_SRCEHypothesis', 'SPSMF_SAPI_PROPERTIES',
    'SpUnCompressedLexicon', 'DISPID_SVEStreamStart',
    'SPFM_OPEN_READWRITE', 'DISPID_SPIEngineId',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechAudioState',
    'DISPID_SpeechMMSysAudio', 'SAFTGSM610_22kHzMono', 'SPAUDIOSTATE',
    'SPINTERFERENCE_NOISE', 'DISPID_SLPsCount', 'DISPID_SVVolume',
    'ISpRecognizer', 'SVPNormal', 'SAFT8kHz16BitStereo',
    'SPPROPERTYINFO', 'SVSFlagsAsync', 'SPRS_INACTIVE',
    'DISPID_SVEPhoneme', 'DISPID_SpeechCustomStream', 'SVP_9',
    'DISPID_SDKGetStringValue', 'SPEI_INTERFERENCE',
    'DISPID_SGRSTText', 'ISpeechGrammarRuleStateTransitions',
    'SAFT22kHz8BitStereo', 'DISPID_SVSInputWordLength',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechPhraseRule', 'SP_VISEME_0',
    'SVP_2', 'SPBOOKMARKOPTIONS', 'SpTextSelectionInformation',
    'SAFT16kHz16BitMono', 'DISPID_SDKEnumValues', 'STSF_AppData',
    'eLEXTYPE_RESERVED9', 'SpeechRegistryLocalMachineRoot',
    'SECFNoSpecialChars', 'SpInprocRecognizer', 'SPAUDIOBUFFERINFO',
    'SPEI_SR_BOOKMARK', 'DISPID_SPIGrammarId', 'SpPhraseInfoBuilder',
    'DISPID_SGRId', 'SPRECORESULTTIMES', 'DISPID_SRRTTickCount',
    'DISPID_SpeechXMLRecoResult', 'SVP_10', 'SpeechDiscardType',
    'SpeechVisemeFeature', 'SpeechInterference', 'DISPID_SRGId',
    'DISPID_SOTCEnumerateTokens', 'SPFM_CREATE_ALWAYS',
    'SPSERIALIZEDPHRASE', 'ISpeechRecoGrammar', 'DISPID_SPRuleParent',
    'eLEXTYPE_PRIVATE2', 'SRCS_Disabled', 'SPFM_NUM_MODES',
    'DISPID_SPCPhoneToId', 'SREAdaptation', 'ISpDataKey',
    'SpeechGrammarState', 'ISpStream', 'DISPID_SVSRunningState',
    'DISPID_SVSLastBookmarkId', 'SPBO_AHEAD', 'DISPID_SGRAddResource',
    'SASRun', 'DISPID_SRCPause', 'DISPID_SWFEChannels',
    'SAFTGSM610_8kHzMono', 'DISPID_SPIGetText',
    'DISPID_SGRSTNextState', 'SVP_5', 'ISpRecoContext2', 'SINoise',
    'SPEI_FALSE_RECOGNITION', 'SpCustomStream',
    'DISPID_SpeechLexiconProns', 'SPEI_HYPOTHESIS',
    'DISPID_SVPriority', 'DISPID_SVEBookmark', 'SVP_11',
    'DISPID_SPRText', 'ISpXMLRecoResult', 'DISPID_SRSClsidEngine',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPGS_ENABLED',
    'SPWORDLIST', 'DISPID_SDKCreateKey',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPPS_Interjection',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SLGetGenerationChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT44kHz8BitStereo',
    'SPCATEGORYTYPE', 'DISPID_SPAsItem', 'tagSPPROPERTYINFO',
    'SPEI_SOUND_START', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpAudioFormat', 'SAFTDefault',
    'DISPID_SVSLastStreamNumberQueued', 'SpVoice',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPRsItem',
    'SPFM_OPEN_READONLY', 'SRATopLevel', 'SPEVENTENUM',
    'DISPID_SRCEEndStream', 'SpeechCategoryAppLexicons',
    'DISPID_SVSpeak', 'DISPID_SpeechVoiceStatus', 'ISpRecoGrammar',
    'ISpSerializeState', 'ISpeechAudio', 'SECLowConfidence',
    'STCLocalServer', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_PRIVATE5',
    'SPEVENTSOURCEINFO', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechVoiceEvent', 'SpeechAudioVolume', 'SGLexical',
    'SP_VISEME_19', 'SRTEmulated', 'SAFT24kHz8BitMono',
    'DISPID_SAVolume', 'ISpeechRecoResultDispatch',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRRTStreamTime', 'SRADefaultToActive', 'ISpNotifySource',
    'SAFT12kHz8BitStereo', 'SAFT48kHz8BitStereo',
    'SPXRO_Alternates_SML', 'SPSHORTCUTPAIR', 'SPEI_ADAPTATION',
    'SDA_One_Trailing_Space', 'SECFIgnoreCase',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechAudio', 'SDTAudio',
    'DISPID_SPACommit', 'SpeechTokenKeyFiles', 'SDTAlternates',
    'SPEI_PHRASE_START', 'SPPS_RESERVED3', 'DISPID_SOTDataKey',
    'SPAS_CLOSED', 'DISPID_SRRTLength', 'DISPID_SRGIsPronounceable',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSAddSpecialTransition',
    'SREStateChange', 'SPPS_Noncontent', 'DISPID_SBSRead',
    'DISPID_SVSInputWordPosition', 'ISpPhraseAlt', 'SPWAVEFORMATTYPE',
    'SPEI_RESERVED2', 'SPPHRASERULE',
    'DISPID_SpeechLexiconPronunciation', 'SpeechRecoEvents',
    'SDTRule', 'SPDKL_CurrentConfig', 'DISPID_SpeechPhraseProperties',
    'tagSPTEXTSELECTIONINFO', 'SVEAudioLevel',
    'DISPID_SPRuleNumberOfElements', 'ISpeechRecoResultTimes',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_RESERVED7', 'DISPID_SPPNumberOfElements',
    'SAFTADPCM_8kHzMono', 'SPSHORTCUTTYPE', 'SVSFParseAutodetect',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPEsItem',
    'SpeechRuleState', 'DISPID_SpeechLexicon',
    'DISPID_SDKSetLongValue', 'SPGRAMMARSTATE', 'SPPS_Unknown',
    'SpMemoryStream', 'SVSFParseSapi', 'SPEI_START_INPUT_STREAM',
    'SP_VISEME_2', 'STSF_LocalAppData', 'SpeechFormatType',
    ...
    'SPEI_VISEME', 'DISPID_SGRsCount', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVDisplayUI', 'DISPID_SpeechRecoContextEvents',
    'DISPIDSPTSI_ActiveOffset', 'SPLOADOPTIONS',
    'SSSPTRelativeToStart', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_1', 'SPVPRI_OVER', 'DISPID_SDKEnumKeys', 'SGSDisabled',
    'DISPID_SRGCmdLoadFromMemory', '_RemotableHandle',
    'DISPID_SPERetainedStreamOffset', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_RESERVED8', 'SVSFIsXML',
    'Speech_Default_Weight', 'SPSEMANTICERRORINFO',
    'SRERecoOtherContext', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SGRSTPropertyId', 'ISpeechRecoResult2',
    'DISPID_SpeechAudioBufferInfo', 'SPSEMANTICFORMAT',
    'SVSFNLPSpeakPunc', 'SPAS_STOP', 'SPINTERFERENCE_TOOFAST',
    'ISpeechPhraseProperty', 'DISPID_SOTCreateInstance',
    'ISpRecoCategory', 'SpeechPropertyResourceUsage', 'SWTAdded',
    'SpeechGrammarTagWildcard', 'SPEI_TTS_BOOKMARK',
    'eLEXTYPE_PRIVATE7', 'DISPID_SMSAMMHandle',
    'DISPID_SLWPronunciations', 'SPEI_END_SR_STREAM',
    'DISPID_SPRuleId', 'SVF_None', 'DISPID_SPPName',
    'SPEI_SR_AUDIO_LEVEL', 'SSSPTRelativeToCurrentPosition',
    'SpeechAllElements', 'DISPIDSPRG', 'SPCT_SUB_DICTATION',
    ...
    'Speech_Max_Pron_Length', 'DISPID_SRCreateRecoContext',
    'SDTLexicalForm', 'DISPID_SOTCId', 'STCRemoteServer',
    'SDTPronunciation', 'SPRECOCONTEXTSTATUS', 'DISPID_SGRSTType',
    'SPEI_REQUEST_UI', 'SPAR_Medium', 'SRSEDone', 'SVP_3',
    'SAFTCCITT_uLaw_11kHzMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpFileStream', 'DISPID_SRRGetXMLErrorInfo',
    ...
    'SAFT24kHz16BitStereo', 'SREBookmark', 'DISPID_SAFType',
    'SGPronounciation', 'SPFILEMODE', 'SPEI_MAX_TTS', 'SP_VISEME_5',
    'ISpPhrase', 'SPEI_START_SR_STREAM', 'SRAORetainAudio',
    'ISpeechRecoContext', 'SAFT22kHz16BitStereo',
    'DISPID_SGRSTransitions', 'SPEI_SOUND_END',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPLEXICONTYPE', 'SBOPause',
    'SVF_Emphasis', 'SpNotifyTranslator', 'SPXMLRESULTOPTIONS',
    'DISPID_SPIProperties', 'SPGRAMMARWORDTYPE', 'SPPS_NotOverriden',
    'DISPID_SpeechMemoryStream', 'ISpeechCustomStream', 'SPCT_SLEEP',
    'SRSActiveAlways', 'DISPID_SVSLastResult', 'DISPID_SABIEventBias',
    'SECNormalConfidence', 'DISPID_SOTCSetId',
    'DISPID_SRRGetXMLResult', 'ISpeechLexiconWords', 'SPPARTOFSPEECH',
    'SRAExport', 'SPEI_END_INPUT_STREAM',
    ...
    'SPDKL_CurrentUser', 'SPINTERFERENCE', 'SPRST_ACTIVE',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRSCurrentStreamNumber', 'SpCompressedLexicon',
    'SPPS_Modifier', 'SVP_13', 'SpeechTokenKeyAttributes',
    'DISPID_SPARecoResult', 'SVP_16', 'SRAImport',
    'DISPID_SGRAddState', 'DISPID_SRRAudioFormat',
    'SREPropertyStringChange', 'ISpeechObjectTokenCategory',
    'SECHighConfidence', 'SpeechSpecialTransitionType', 'SITooQuiet',
    'ISpeechRecognizer', 'DISPID_SPAsCount', 'SSSPTRelativeToEnd',
    'DISPID_SRAudioInputStream', 'DISPID_SLPLangId',
    'SAFT12kHz8BitMono', 'SAFTNoAssignedFormat', 'SPAUDIOOPTIONS',
    'SVSFUnusedFlags', 'SLTApp', 'SDKLCurrentConfig',
    'DISPID_SFSClose', 'eLEXTYPE_PRIVATE8', 'SFTInput',
    'DISPID_SpeechVoice', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGDictationUnload', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVPause', 'SpShortcut', 'DISPID_SRCERecognition',
    'DISPID_SGRSAddRuleTransition', 'SVP_6', 'eWORDTYPE_ADDED',
    'DISPIDSPTSI_SelectionOffset', 'SPEVENT',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRInitialState',
    'DISPID_SRGCmdSetRuleState', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT12kHz16BitStereo', 'DISPID_SPPId', 'SPSNotOverriden',
    'DISPID_SVEWord', 'DISPID_SPPsItem', 'ISpeechGrammarRule',
    'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_13', 'DISPID_SRGRules',
    'DISPID_SOTSetId', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SDKLCurrentUser', 'DISPID_SPRs_NewEnum', 'SpeechCategoryAudioIn',
    'ISpeechAudioStatus', 'SVP_0', 'SGRSTTWord', 'SWTDeleted',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SLGetPronunciations',
    'ISpRecoResult', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRs_NewEnum', 'SDA_Consume_Leading_Spaces',
    'SPRECOSTATE', 'DISPIDSPTSI',
    'SpeechGrammarRuleStateTransitionType', 'SpeechDataKeyLocation',
    'SVEStartInputStream', 'SpeechAudioProperties',
    'SpPhoneticAlphabetConverter', 'SVP_20', 'SAFT16kHz16BitStereo',
    'SVPAlert', 'DISPID_SPAPhraseInfo', 'SPSHT_NotOverriden',
    'SWPKnownWordPronounceable', 'SpeechRecoProfileProperties',
    'SAFT32kHz8BitStereo', 'ISpeechDataKey', 'SPCT_DICTATION',
    'SpeechRecoContextState', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRStatus', 'SDA_No_Trailing_Space', 'SPSSuppressWord',
    'SAFT32kHz16BitStereo', 'SpeechCategoryRecoProfiles',
    'SpeechPropertyComplexResponseSpeed', 'SREHypothesis',
    'SpLexicon', 'SREInterference', 'DISPID_SPRDisplayAttributes',
    'SPSERIALIZEDRESULT', 'SpeechTokenValueCLSID', 'SDTDisplayText',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRProfile',
    'ISpeechPhraseAlternates', 'SPRST_ACTIVE_ALWAYS', 'SPPS_Function',
    'SPDKL_DefaultLocation', 'SPPHRASEPROPERTY', 'DISPID_SPCLangId',
    ...
    'SP_VISEME_17', 'SVP_8', 'WAVEFORMATEX', 'SVEPrivate',
    'SpeechCategoryRecognizers', 'DISPID_SLPSymbolic', 'SPSNoun',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_RESERVED4',
    'DISPID_SGRClear', 'DISPID_SDKSetBinaryValue',
    'DISPID_SADefaultFormat', 'SGDSActive',
    'DISPID_SRCVoicePurgeEvent', 'Speech_Max_Word_Length',
    'DISPID_SPEActualConfidence', 'SpeechRuleAttributes',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVSkip',
    'Speech_StreamPos_Asap', 'ISpShortcut', 'SPRS_ACTIVE',
    'DISPID_SGRSTPropertyValue', 'SVP_12', 'DISPID_SRGetRecognizers',
    'SECFIgnoreKanaType', 'DISPID_SRGReset', 'SDTProperty',
    'SPGS_EXCLUSIVE', 'SVSFIsFilename', 'DISPID_SPRsCount',
    'ISpStreamFormat', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_RESERVED6', 'SPSFunction', 'SPCT_COMMAND',
    'SpeechTokenKeyUI', 'SRADynamic', 'DISPID_SVGetProfiles',
    'DISPID_SRCESoundStart', 'ISpNotifySink', 'SPWORDPRONUNCIATION',
    'DISPIDSPTSI_ActiveLength', 'SP_VISEME_4',
    'DISPID_SPELexicalForm', 'DISPID_SVEAudioLevel', 'SPWF_SRENGINE',
    ...
    'SVSFPersistXML', 'SpeechEmulationCompareFlags',
    'DISPID_SLPsItem', 'DISPID_SpeechFileStream',
    'DISPID_SRCEAdaptation', 'SAFTADPCM_11kHzStereo',
    'SPRST_INACTIVE', 'SVP_15', 'ISpeechBaseStream', 'SPSHT_Unknown',
    'SAFTADPCM_44kHzMono', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVGetAudioOutputs', 'SPCS_ENABLED',
    'DISPID_SRCERequestUI', 'SAFT22kHz16BitMono',
    'SPEI_WORD_BOUNDARY', 'SPPHRASEREPLACEMENT', 'DISPID_SVEViseme',
    'DISPID_SPAStartElementInResult', 'DISPID_SRCResume',
    'SpMMAudioIn', 'DISPID_SRRRecoContext',
    'DISPID_SpeechPhraseAlternates', 'SpeechUserTraining',
    'DISPID_SDKDeleteKey', 'DISPID_SOTCGetDataKey', 'SPEI_MAX_SR',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCONTEXTSTATE',
    'DISPID_SRRSaveToMemory', 'SGRSTTRule', 'SpMMAudioOut', 'SVP_4',
    'SITooSlow', 'eLEXTYPE_PRIVATE14', 'SVEViseme',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRGRecoContext',
    'DISPID_SPIElements', 'SAFT48kHz16BitStereo', 'SpeechLoadOption',
    ...
    'DISPID_SPEDisplayText', 'SPAUDIOSTATUS', 'tagSTATSTG',
    'SpeechCategoryPhoneConverters', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SAFGuid', 'DISPID_SpeechPhraseRule',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPCT_SUB_COMMAND', 'SGDSActiveWithAutoPause', 'SPSHT_EMAIL',
    'DISPID_SpeechPhraseReplacements', 'SP_VISEME_16', 'SVP_19',
    'SPSVerb', 'SPVPRI_NORMAL', '_ISpeechVoiceEvents',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_PRIVATE18', 'SPPS_LMA',
    'SLODynamic', 'SPINTERFERENCE_TOOLOUD',
    ...
    'ISpeechPhraseElements', 'SPWORDTYPE', 'IEnumString', 'SASStop',
    'SpeechAddRemoveWord', 'STCInprocServer', 'SAFT44kHz16BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPBO_NONE',
    'SPSMF_UPS', 'DISPID_SGRsAdd', 'SP_VISEME_14',
    'SAFTGSM610_11kHzMono', 'SpObjectTokenCategory',
    'DISPID_SWFEExtraData', 'SPWT_PRONUNCIATION', 'LONG_PTR',
    'eLEXTYPE_RESERVED6', 'SPAR_High', 'STSF_FlagCreate',
    'DISPID_SVGetVoices', 'SITooFast', 'DISPID_SVAudioOutputStream',
    'SGDisplay', 'SP_VISEME_20', 'DISPID_SRGetFormat',
    'SpeechRegistryUserRoot', 'SAFT16kHz8BitStereo',
    'DISPID_SPIStartTime', 'ISpeechLexiconWord', 'SGDSInactive',
    ...
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTRemove', 'SAFT8kHz16BitMono',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechLexiconType',
    'DISPID_SGRSTWeight', 'SRTExtendableParse',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SGRSTRule',
    'SAFT8kHz8BitStereo', 'SP_VISEME_3', 'SAFT32kHz16BitMono',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE20', 'SPWT_LEXICAL',
    'SPSHT_OTHER', 'SpeechRunState', 'SpeechCategoryAudioOut',
    'eLEXTYPE_PRIVATE9', 'SVP_17', 'SpWaveFormatEx',
    'SDA_Two_Trailing_Spaces', 'SpeechBookmarkOptions',
    'SPSTREAMFORMATTYPE', 'ISpObjectToken', 'DISPID_SPAs_NewEnum',
    'SREPropertyNumChange', 'DISPID_SVResume', 'DISPID_SPPParent',
    ...
    'DISPID_SBSFormat', 'SPEI_RESERVED1',
    'DISPID_SPPEngineConfidence', 'DISPID_SBSSeek',
    'eLEXTYPE_PRIVATE1', 'SREStreamStart', 'SSFMOpenReadWrite',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPPHRASE', 'DISPID_SRRSpeakAudio',
    'DISPID_SVGetAudioInputs', 'ISpeechRecoResult',
    'DISPID_SRGCmdLoadFromResource', 'STCInprocHandler', 'STCAll',
    'DISPID_SPRulesItem', 'SREStreamEnd', 'DISPID_SFSOpen',
    ...
    'DISPID_SOTGetStorageFileName', 'SP_VISEME_9',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechPhoneConverter',
    'SpeechDictationTopicSpelling', 'SVEBookmark',
    ...
    'SPSUnknown', 'SpeechVoiceSkipTypeSentence',
    'SpeechVoiceCategoryTTSRate', 'ISpeechPhraseAlternate',
    'SpeechEngineConfidence', 'ISpEventSource', 'ISequentialStream',
    'IInternetSecurityMgrSite', 'DISPID_SRIsUISupported',
    'SECFEmulateResult', 'SpeechVoiceSpeakFlags', 'SP_VISEME_6',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCEInterference',
    'SVSFParseMask', 'DISPID_SRIsShared', 'SVSFDefault',
    'ISpeechPhraseInfoBuilder', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFT32kHz8BitMono', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechLexiconWord', 'ISpeechPhraseRules', 'SREAllEvents',
    'SPPS_SuppressWord', 'SASPause', 'DISPID_SRDisplayUI',
    'ISpeechTextSelectionInformation', 'DISPID_SAEventHandle',
    'DISPID_SRCRetainedAudio', 'DISPID_SRCRequestedUIType',
    'SPEI_RECO_OTHER_CONTEXT', 'SREPrivate', 'SRTSMLTimeout',
    'DISPID_SpeechDataKey', 'DISPID_SLWsItem', 'ISpAudio', 'SPAR_Low',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVEAllEvents',
    'SRSInactiveWithPurge', 'SSTTTextBuffer',
    'DISPID_SWFEBitsPerSample', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechLexiconWords', 'DISPID_SRCEEnginePrivate',
    'SAFT48kHz16BitMono', 'SGRSTTEpsilon',
    'Speech_StreamPos_RealTime', 'DISPID_SPERetainedSizeBytes',
    'SGRSTTWildcard', 'SVESentenceBoundary', 'SAFT22kHz8BitMono',
    'SPFM_CREATE', 'SRTAutopause', 'ISpGrammarBuilder', 'SPAO_NONE',
    ...
    'SPEI_UNDEFINED', 'DISPID_SPPFirstElement', 'SAFT48kHz8BitMono',
    'ISpRecoGrammar2', 'DISPID_SRGDictationSetState',
    'DISPID_SpeechPhraseProperty', 'SVSFNLPMask', 'SRTReSent',
    'SP_VISEME_18', 'DISPID_SBSWrite', 'DISPID_SRRAudio',
    'ISpeechMMSysAudio', 'SRAONone', 'SVPOver', 'SPVPRIORITY',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechPhraseRules',
    'DISPID_SLPPhoneIds', 'DISPID_SpeechPhraseElement',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVWaitUntilDone',
    'DISPID_SGRsDynamic', 'SP_VISEME_11', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRSSupportedLanguages', 'SREAudioLevel', 'ISpMMSysAudio',
    'SVEWordBoundary', 'SpeechRetainedAudioOptions',
    'SpeechVisemeType', 'SpeechRecognizerState', 'SRSActive',
    'SDTReplacement', 'DISPID_SRSNumberOfActiveRules', 'SP_VISEME_15',
    'SPEI_MIN_SR', 'eLEXTYPE_USER', 'DISPID_SRCEventInterests',
    'DISPIDSPTSI_SelectionLength', 'SPXRO_SML', 'ISpeechVoice',
    'ISpeechPhraseReplacement', 'DISPID_SDKOpenKey',
    'SpInProcRecoContext', 'SPBINARYGRAMMAR', 'SAFT44kHz8BitMono',
    'SpeechWordType', 'DISPID_SPEs_NewEnum', 'SP_VISEME_10',
    'SPEI_PHONEME', 'ISpeechObjectTokens', 'SBONone', 'SAFTText',
    'DISPID_SPPChildren', 'DISPID_SpeechRecoResult',
    'eLEXTYPE_PRIVATE17', 'SPPS_RESERVED2', 'SGLexicalNoSpecialChars',
    'DISPID_SRGDictationLoad', 'SPAS_PAUSE',
    'DISPID_SVSInputSentencePosition', 'SPRST_NUM_STATES',
    'SPEI_RESERVED3', 'SPPS_RESERVED4', 'DISPID_SASNonBlockingIO',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRRTimes', 'SpeechRecognitionType',
    'SGRSTTDictation', 'DISPID_SpeechGrammarRules',
    'SPEI_TTS_PRIVATE', 'DISPID_SVEStreamEnd', 'DISPID_SVRate',
    'SVP_14', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpNullPhoneConverter', 'SAFT8kHz8BitMono',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRSTsItem', 'SPRULE',
    'SPBO_PAUSE', 'DISPID_SpeechObjectToken', 'DISPID_SRCVoice',
    'DISPID_SRRAlternates', 'SpeechCategoryVoices',
    'ISpeechPhraseProperties', 'ISpeechWaveFormatEx',
    'DISPID_SRCERecognizerStateChange', 'ISpRecognizer2', 'UINT_PTR',
    'eLEXTYPE_PRIVATE6', 'ISpObjectTokenCategory', 'SRERecognition',
    'DISPID_SVStatus', 'SRESoundStart', 'eWORDTYPE_DELETED',
    'ISpObjectWithToken', 'SINone', 'DISPID_SWFEBlockAlign',
    'ISpProperties', 'SAFT24kHz16BitMono', 'DISPID_SASetState',
    'DISPID_SRSAudioStatus', 'DISPID_SDKGetlongValue',
    'DISPID_SGRsCommit', 'DISPID_SRRDiscardResultInfo',
    'SPINTERFERENCE_TOOSLOW', 'SpeechTokenContext', 'DISPID_SOTId',
    'SAFT11kHz16BitStereo', 'eLEXTYPE_PRIVATE11', 'SPPS_RESERVED1',
    'SpeechPartOfSpeech', 'SpeechGrammarWordType', 'SPEI_MIN_TTS',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPIRule',
    'SPADAPTATIONRELEVANCE', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVAudioOutput',
    'SPCS_DISABLED', 'SPEI_VOICE_CHANGE', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCCreateGrammar', 'SPSHORTCUTPAIRLIST',
    'DISPID_SLGenerationId', 'SAFT12kHz16BitMono', 'SVP_1',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRGCommit', 'DISPID_SASState',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SLRemovePronunciation', 'DISPID_SOTsItem',
    'SPEI_RECOGNITION', 'DISPID_SPIAudioSizeBytes', 'DISPID_SLWWord',
    'SPSInterjection', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRPhraseInfo',
    'SAFTADPCM_44kHzStereo', 'SAFTADPCM_11kHzMono', 'DISPID_SPPValue',
    'SSTTWildcard', 'DISPID_SPIReplacements', 'DISPID_SOTCategory',
    'DISPID_SRCRecognizer', 'eLEXTYPE_PRIVATE19', 'SpeechVoiceEvents',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPVPRI_ALERT',
    'SpStream', 'SDTAll', 'ISpeechObjectToken', 'SGSExclusive',
    'DISPID_SRSCurrentStreamPosition', 'SAFTExtendedAudioFormat',
    'SECFDefault', 'DISPID_SGRSAddWordTransition', 'DISPID_SOTsCount',
    'SPDKL_LocalMachine', 'DISPID_SOTCDefault',
    'DISPID_SABIBufferSize', 'SpeechStreamSeekPositionType',
    'SFTSREngine', 'DISPID_SPPs_NewEnum', 'DISPID_SRCEAudioLevel',
    'SpeechMicTraining', 'DISPID_SPIEnginePrivateData', 'SVP_18',
    'DISPID_SRCESoundEnd', 'DISPID_SABufferNotifySize',
    'DISPID_SRRSetTextFeedback', 'DISPID_SOTs_NewEnum', 'SITooLoud',
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_PRIVATE12', 'SRSInactive',
    'SLOStatic', 'SVSFVoiceMask',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechDisplayAttributes',
    'SVP_21', 'IEnumSpObjectTokens', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SGRAttributes', 'ISpeechPhraseInfo',
    'DISPID_SpeechRecognizer', 'DISPID_SRGCmdSetRuleIdState',
    'ISpRecoContext', 'SpeechVoicePriority', 'SVSFIsNotXML',
    'SP_VISEME_21', 'SRERequestUI', 'SPEI_SR_PRIVATE',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPRuleName',
    'SVSFPurgeBeforeSpeak', 'ISpLexicon', 'SAFT11kHz8BitMono',
    'SRTStandard', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGSEnabled', 'STSF_CommonAppData',
    'DISPID_SRGSetTextSelection', 'DISPID_SPEEngineConfidence',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPCIdToPhone',
    'SRAInterpreter', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPAS_RUN',
    'SSFMCreate', 'SPAR_Unknown', 'SPPHRASEELEMENT',
    'DISPID_SWFEFormatTag', 'SpStreamFormatConverter',
    'DISPID_SVESentenceBoundary', 'DISPID_SPPsCount',
    'SpResourceManager', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SLWsCount', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SLWType', 'ISpeechVoiceStatus', 'ISpeechPhraseElement',
    'SLTUser', 'DISPID_SpeechAudioStatus', 'SpeechTokenIdUserLexicon',
    'DISPID_SVIsUISupported', 'DISPID_SRGState', 'SREPhraseStart',
    'SECFIgnoreWidth', 'SP_VISEME_8', 'DISPID_SGRsItem',
    'DISPID_SAStatus', 'SAFTNonStandardFormat', 'DISPID_SGRSTsCount',
    'ISpPhoneConverter', 'eLEXTYPE_RESERVED10'
]

_check_version('1.2.0', 1700012845.769190)
